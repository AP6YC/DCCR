"""
    split_tiny_imagenet.py

# Description
This experiment implements a DDVFA strategy on the Split-Tiny-Imagenet dataset.
"""
...
from src.datasets import SplitTinyImageNetPreprocessed
...
def ddvfa_splittinyimagenet(
    override_args: Optional[dict] = None
) -> Tuple[list, list, float]:
    """DDVFA Avalanche strategy on the Split-Tiny-Imagenet benchmark in a fast
    condensed scenario.
...
if __name__ == "__main__":
    train_results, test_results, avg_perf = ddvfa_splittinyimagenet()
