...
This page serves as the contribution guide for the `DCCR` package.
...
The main point of contact is the [GitHub issues](https://github.com/AP6YC/DCCR/issues) page for the project.
...
```sh
git clone git@github.com:AP6YC/DCCR.jl.git
julia --project=.
```
...
The `DCCR` package follows the [GitFlow](https://nvie.com/posts/a-successful-git-branching-model/) git working model.
...
3. When you are satisfied with your changes, initiate a [GitHub pull request](https://github.com/AP6YC/DCCR.jl/pulls) (PR) to merge the feature branch with `develop`.
